...
User.create!(:name => "turiyoka", :user_type => "Creator", :ytube_page =>"https://www.youtube.com/channel/UC4QadOSsJu54Qs8z99shRiQ", :introduction => "とにかく釣りの楽しさを伝えたい！主にバス釣り・ライトショアジギングをやっているが、特に釣りが上手いという事でもない。youtubeの動画投稿で経験を積んで、釣りのレベルも上達すればいいなぁ～。",  :email => "turiyoka@knetaro.com", :password => "kentaro",  :genre1 => "釣り",  :genre2 => "料理", :genre3 => "アウトドア", :kakutoku => 0, :prem_price => 1000,:confirmed_at => "Sun, 17 Dec 2017 01:04:18 UTC +00:00" )

User.create!(:name => "kazumeshi", :user_type => "Creator", :ytube_page =>"https://www.youtube.com/user/kazumeshi",:introduction => "一般人カズによる料理系投稿チャンネルです。もちろん料理は初心者、特別何ができるってわけでもないです。ただこれからの男は料理もできないといけないらしい。という事でお料理の勉強を動画を通してしていくぞ。", :email => "kazumeshi@knetaro.com", :password => "kentaro",  :genre1 => "料理",  :genre2 => "アウトドア", :genre3 => "男飯", :kakutoku => 0, :prem_price => 500,:confirmed_at => "Sun, 17 Dec 2017 01:04:18 UTC +00:00" )

User.create!(:name => "bilingirl", :user_type => "Creator",:ytube_page =>"https://www.youtube.com/user/cyoshida1231", :introduction => "部屋からパジャマ姿でレッスンをしたり、旅行先でビデオブログを作ったり、衣装を着て踊ったり（最近は、苦手な歌にも挑戦w）！友達感覚で気軽に英語に触れていただける動画を心がけています☆ ",:email => "bairingaru@knetaro.com", :password => "kentaro",  :genre1 => "英語",  :genre2 => "海外", :genre3 => "留学", :kakutoku => 0, :prem_price => 10000,:confirmed_at => "Sun, 17 Dec 2017 01:04:18 UTC +00:00" )

User.create!(:name => "renren", :user_type => "Creator",:ytube_page =>"https://www.youtube.com/channel/UCXz-UOc1p3p3Y23CWS-AMfQ",:introduction => "色々な運動やしゃべるだけの動画やゲーム実況などなどを投稿していければ嬉しいです！見てくれてありがとう！感謝しています! チャンネル登録よろしくお願いします！好きな歌はシャープオフユーとシェイクイッツオフとグットタイムです！ぜひ聞いてみてね！", :email => "renren@knetaro.com", :password => "kentaro",  :genre1 => "パルクール",  :genre2 => "アウトドア", :genre3 => "中学生", :kakutoku => 0, :prem_price => 100, :confirmed_at => "Sun, 17 Dec 2017 01:04:18 UTC +00:00" )

User.create!(:name => "tokusan", :user_type => "Creator",:ytube_page =>"https://www.youtube.com/channel/UCfkM3u-0uSKADDitZLpXcfA/featured?disable_polymer=1",:introduction => "このチャンネルは草野球チーム天晴の「トクサン」と「ライパチボーイ」の２人が、【野球がうまくなる練習法】や【試合実況】をお届けするチェンネルです。",:email => "tokusan@knetaro.com", :password => "kentaro",  :genre1 => "野球",  :genre2 => "メジャーリーガー", :genre3 => "リポーター", :kakutoku => 0, :prem_price => 250, :confirmed_at => "Sun, 17 Dec 2017 01:04:18 UTC +00:00")
